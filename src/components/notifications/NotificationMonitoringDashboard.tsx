...
import { AlertTriangle, Clock, CheckCircle, XCircle, RefreshCw, TestTube, Code } from 'lucide-react';
...
import { AdvancedNotificationTesting } from './AdvancedNotificationTesting';
        ...
        <TabsContent value="overview" className="space-y-6">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Real-time monitoring of notification delivery and system status
                </CardDescription>
              </div>
              <Button 
                variant="outline" 
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Test your local notification system with a single notification
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="logs" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Real-time view of notification system activity
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-8 text-muted-foreground">
                <Code className="w-8 h-8 mx-auto mb-2 opacity-50" />
                <p>Advanced logging available in Debugging tab</p>
                <p className="text-sm">Check console for real-time logs</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
