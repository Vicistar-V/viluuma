-- Add enhanced goal completion tracking and status management
-- This migration adds improved completion tracking for goals

-- Update goals table to ensure completed_at is properly handled
-- (The column already exists, but we want to ensure it's properly managed)

-- Create a function to handle goal completion logic
...
-- Create a function to get goal statistics
