...
-- Phase 5: Update the update_parent_progress trigger to be simpler
...
-- Phase 6: Remove the handle_goal_completion trigger as it's no longer needed
DROP TRIGGER IF EXISTS handle_goal_completion_trigger ON public.goals;
