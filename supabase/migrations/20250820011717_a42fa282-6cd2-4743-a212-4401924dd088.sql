-- Update save_goal_plan function to accept and save description
DROP FUNCTION IF EXISTS public.save_goal_plan(text, text, text, jsonb, jsonb);
...
BEGIN
  ...
  VALUES (v_user_id, p_title, p_modality, v_target_date, p_description)
